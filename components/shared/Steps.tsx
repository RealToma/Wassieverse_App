const steps = [
  { id: 'Step 1', name: 'Connect Your Wallet', href: '#', status: 'current' },
  { id: 'Step 2', name: 'Select Your NFTs', href: '#', status: 'upcoming' },
  { id: 'Step 3', name: 'Transfer Your NFTs', href: '#', status: 'upcoming' },
]
